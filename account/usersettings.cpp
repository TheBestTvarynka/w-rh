...
UserSettings::UserSettings(Account *p, QMap<QString, QVariant> data)
{
    Parent = p;
    userData = data;
    ...
    QPushButton *saveSettings = new QPushButton("Save");
    connect(saveSettings, SIGNAL(clicked()), this, SLOT(SaveSettings()));
    QSpacerItem *spaceOk = new QSpacerItem(40, 60, QSizePolicy::Expanding, QSizePolicy::Preferred);
    QHBoxLayout *save = new QHBoxLayout;
    save->addItem(spaceOk);
    save->addWidget(saveSettings);

    QSpacerItem *spaceMain = new QSpacerItem(40, 60, QSizePolicy::Preferred, QSizePolicy::Expanding);
